...
contract CryptoDevsDAO is Ownable {
    ...
    modifier activeProposalOnly(uint256 proposalIndex) { //modifer takes a parameter
        require(
    ...
    modifier inactiveProposalOnly(uint256 proposalIndex) {
        require(proposals[proposalIndex].deadline <= block.timestamp, "Deadline not exceeed");
